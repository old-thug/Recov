...
typedef void (*UIOnFocusFn)(UIBase *, SDL_Renderer*);
typedef void (*UIUpdateFn)(UIBase *, SDL_Renderer *);
typedef void (*UIOnMouseEnterFn)(UIBase *, SDL_Renderer*);
typedef void (*UIOnMouseExitFn)(UIBase *, SDL_Renderer*);
typedef void (*UIOnMouseClickFn)(UIBase *, SDL_Renderer*);
...
UIBase *UIBaseInit(size_t size, UIRect rect, UIComponentType type,
                   UIOnFocusFn on_focus, UIUpdateFn on_update, void *user_data);
bool UIBaseIsFocused(UIBase *base);
void UIBaseUpdate(UIBase *base, SDL_Renderer *renderer);
